...
const bundleSize = Buffer.byteLength(contents, 'utf8');
if (bundleSize < MIN_BUNDLE_BYTES) {
  throw new Error(
    `Generated bundle appears truncated (only ${bundleSize} bytes). ` +
      'Restore agentflow_mvp/dist/server.cjs (e.g. via `git checkout -- agentflow_mvp/dist/server.cjs`) ' +
